...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for daggerHilt (com.google.dagger:hilt-android)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDaggerHilt() {
            return create("daggerHilt");
    }

        /**
         * Creates a dependency provider for daggerHiltNavigation (androidx.hilt:hilt-navigation-compose)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDaggerHiltNavigation() {
            return create("daggerHiltNavigation");
    }
        ...
        /**
         * Creates a dependency provider for kaptDaggerHilt (com.google.dagger:hilt-compiler)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKaptDaggerHilt() {
            return create("kaptDaggerHilt");
    }

        /**
         * Creates a dependency provider for kotlinxCorutines (org.jetbrains.kotlinx:kotlinx-coroutines-test-jvm)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKotlinxCorutines() {
            return create("kotlinxCorutines");
    }

        /**
         * Creates a dependency provider for mockitoAndroid (org.mockito:mockito-android)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMockitoAndroid() {
            return create("mockitoAndroid");
    }
        ...
        /**
         * Creates a dependency provider for paginCompose (androidx.paging:paging-compose)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPaginCompose() {
            return create("paginCompose");
    }

        /**
         * Creates a dependency provider for paginRuntime (androidx.paging:paging-runtime)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPaginRuntime() {
            return create("paginRuntime");
    }
    ...
    public static class Retrofit2LibraryAccessors extends SubDependencyFactory {
        ...
        public Retrofit2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getConverter() {
                return create("retrofit2.converter");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: coroutinesTest (1.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: paginCompose (3.2.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPaginCompose() { return getVersion("paginCompose"); }
